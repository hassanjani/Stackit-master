...
class Tenant_Table_Screen extends StatefulWidget {
  const Tenant_Table_Screen({Key key}) : super(key: key);

  @override
  _Tenant_Table_ScreenState createState() => _Tenant_Table_ScreenState();
}

class _Tenant_Table_ScreenState extends State<Tenant_Table_Screen> {
  var orientation, size, height, width;
  tenant_home_Get postService = tenant_home_Get();
  // List<String> list1 = ['Tenant/Tr']; //]; // Option 2
