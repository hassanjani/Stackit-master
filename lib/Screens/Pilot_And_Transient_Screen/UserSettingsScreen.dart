...
class PT_UserSettings extends StatefulWidget {
  @override
  _PT_UserSettingsState createState() => _PT_UserSettingsState();
}

class _PT_UserSettingsState extends State<PT_UserSettings> {
  bool check = true;
  DataModel model;
  ...
  UpdateUserDetails() async {
    ...
    var map = {
      "id": "$id",
      "firstname": fNamee.text,
      "Lastname": LNamee.text,
      "email": email.text,
      "password": pass.text,
      "phone": phone.text,
      "phone2": phone2.text,
...
class Tenant_Services {
  ...
  Future getData() async {
    ...
    String id = await prefs.getString('userid');
    var url = Uri.parse(
        "http://wordpresswebsiteprogrammer.com/stackit/public/api/user-settings/pilot?id=$id");
