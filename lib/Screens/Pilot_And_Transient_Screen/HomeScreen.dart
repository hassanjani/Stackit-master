...
class Pilot_A_Transient_Home extends StatefulWidget {
  final int selectedTypeId;
  final int id;
  const Pilot_A_Transient_Home({Key key, this.selectedTypeId, this.id})
      : super(key: key);

  @override
  _Pilot_A_Transient_HomeState createState() => _Pilot_A_Transient_HomeState();
}

// ignore: camel_case_types
class _Pilot_A_Transient_HomeState extends State<Pilot_A_Transient_Home> {
  Get postService = Get();
  // List<String> list1 = ['Tenant/Tr']; //'Company', 'Fbo', 'pilot']; // Option 2
                        ...
                        InkWell(
                          ...
                          onTap: () {
                            Navigator.push(
                                ...
                                MaterialPageRoute(
                                    builder: (context) =>
                                        Pilot_A_Transient_Table_Activity()));
                          },
                        ),
                      ],
                    ),
