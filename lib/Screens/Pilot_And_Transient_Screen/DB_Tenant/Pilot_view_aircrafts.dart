...
class Pilot_View_Aircrafts extends StatefulWidget {
  @override
  _Pilot_View_AircraftsState createState() => _Pilot_View_AircraftsState();
}

class _Pilot_View_AircraftsState extends State<Pilot_View_Aircrafts> {
  String selectedName;
  List data = List();
