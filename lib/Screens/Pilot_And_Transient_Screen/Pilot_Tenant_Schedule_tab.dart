...
import 'package:flutter_forget_pass_recover_with_verify/Screens/Pilot_And_Transient_Screen/DB_Tenant/Pilot_FBO_DB_Tenant.dart';
import 'package:flutter_forget_pass_recover_with_verify/Screens/Pilot_And_Transient_Screen/DB_Tenant/Pilot_FBO_DB_Tenant_Aircrafts.dart';
...
import 'DB_Tenant/Pilot_DB_Pilot.dart';
import 'DB_Tenant/Pilot_DB_Tenant_Building.dart';

// ignore: camel_case_types
class Pilot_Tenant_Schedule_Tab extends StatefulWidget {
  @override
  _Pilot_Tenant_Schedule_TabState createState() =>
      _Pilot_Tenant_Schedule_TabState();
}

// ignore: camel_case_types
class _Pilot_Tenant_Schedule_TabState extends State<Pilot_Tenant_Schedule_Tab> {
  ...
  GetData() async {
    getSharedPref();
    Provider.of<Pilot_TenantScheduleProvider>(context, listen: false)
        .getServices();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Pilot_DB_Tenant(),
              SimpleText("Pilots"),
              Pilot_DB_Tenant_Pilot(),
              SimpleText("Aircrafts"),
              Pilot_DB_Tenant_Aircrafts(),
              SimpleText("Buildings"),
              Pilot_DB_Tenant_Building(),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                children: [
                  Column(
      ...
      Container(
          ...
          child: FutureBuilder(
              future: Provider.of<Pilot_TenantScheduleProvider>(context,
                      listen: false)
                  .getServices(),
  ...
  save_Reservation() async {
    var pp = Provider.of<Pilot_TenantScheduleProvider>(context, listen: false);
...
class Pilot_TenantScheduleProvider extends ChangeNotifier {
  String Tid = "";
  String Pid = "";
  String Aid = "";
  String Bid = "";
  ...
  Future<List<ServicesModel>> getServices() async {
    ...
    var map = {"user_id": "$id", "user_type_id": "4", "schedule_type": "1"};
