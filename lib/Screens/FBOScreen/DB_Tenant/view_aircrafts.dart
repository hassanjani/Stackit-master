...
class FBO_View_Aircrafts extends StatefulWidget {
  @override
  _FBO_View_AircraftsState createState() => _FBO_View_AircraftsState();
}

class _FBO_View_AircraftsState extends State<FBO_View_Aircrafts> {
  String selectedName;
  List data = List();
