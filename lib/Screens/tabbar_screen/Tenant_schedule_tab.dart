...
class Tenant_Schedule_Tab extends StatefulWidget {
  @override
  _Tenant_Schedule_TabState createState() => _Tenant_Schedule_TabState();
}

// ignore: camel_case_types
class _Tenant_Schedule_TabState extends State<Tenant_Schedule_Tab> {
          ...
          child: Column(
            children: [
              ...
              Container(
                  ...
                  child: FutureBuilder(
                      future: Provider.of<TenantScheduleProvider>(context,
                              listen: false)
                          .getServices(),
...
class TenantScheduleProvider extends ChangeNotifier {
  String Tid = "";
  String Pid = "";
  String Aid = "";
  String Bid = "";
